...
/**
 *	\file       htdocs/gestiondescommerciaux/template/gestiondescommerciauxindex.php
 *	\ingroup    gestiondescommerciaux
 *	\brief      Home page of gestiondescommerciaux top menu
 */
...
$langs->loadLangs(array("gestiondescommerciaux@gestiondescommerciaux"));

$action=GETPOST('action', 'alpha');


// Securite acces client
if (! $user->rights->gestiondescommerciaux->read) accessforbidden();
...
llxHeader("",$langs->trans("GestionDesCommerciauxArea"));

print load_fiche_titre($langs->trans("GestionDesCommerciauxArea"),'','gestiondescommerciaux.png@gestiondescommerciaux');
...
// Draft MyObject
if (! empty($conf->gestiondescommerciaux->enabled) && $user->rights->gestiondescommerciaux->read)
{
	$langs->load("orders");
