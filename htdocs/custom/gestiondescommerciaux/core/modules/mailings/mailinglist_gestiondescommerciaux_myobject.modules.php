...
dol_include_once("/gestiondescommerciaux/class/myobject.class.php");


/**
 * mailing_mailinglist_gestiondescommerciaux
 */
class mailing_mailinglist_gestiondescommerciaux_myobject extends MailingTargets
{
	// CHANGE THIS: Put here a name not already used
	var $name='mailinglist_gestiondescommerciaux_myobject';
	...
	var $picto='gestiondescommerciaux@gestiondescommerciaux';
	...
	function __construct($db)
	{
		...
		{
			$this->enabled=in_array('gestiondescommerciaux',$conf->modules)?1:0;
		}
	}
	...
	function url($id)
	{
		return '<a href="'.dol_buildpath('/gestiondescommerciaux/myobject_card.php',1).'?id='.$id.'">'.img_object('',"generic").'</a>';
	}
	...
	function add_to_target($mailing_id,$filtersarray=array())
	{
		...
		if ($result)
		{
			...
			dol_syslog("mailinglist_gestiondescommerciaux_myobject.modules.php: mailing ".$num." targets found");
