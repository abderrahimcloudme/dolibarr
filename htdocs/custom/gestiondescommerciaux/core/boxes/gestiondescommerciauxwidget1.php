...
/**
 * \file    modulebuilder/template/core/boxes/gestiondescommerciauxwidget1.php
 ...
 */
class gestiondescommerciauxwidget1 extends ModeleBoxes
{
	/**
	...
	public function loadBox($max = 5)
	{
		...
		$text = $langs->trans("Alerte appels", $max);
