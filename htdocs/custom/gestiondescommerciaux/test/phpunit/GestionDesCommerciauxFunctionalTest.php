...
/**
 * \file    test/functional/GestionDesCommerciauxFunctionalTest.php
...
/**
 * Class GestionDesCommerciauxFunctionalTest
 *
 ...
 *
 * @package Testgestiondescommerciaux
 */
class GestionDesCommerciauxFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
...
//        )
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modGestionDesCommerciaux')->click();
		} else {
			// Disable the module
			$this->byHref('modGestionDesCommerciaux')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/gestiondescommerciaux/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('gestiondescommerciaux/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/gestiondescommerciaux/admin/about.php');
		$this->authenticate();
		return $this->assertContains('gestiondescommerciaux/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('gestiondescommerciauxwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modGestionDesCommerciaux_GestionDesCommerciauxTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modGestionDesCommerciaux_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
