...
/**
 * \file    gestiondescommerciaux/class/api_gestiondescommerciaux.class.php
 * \ingroup gestiondescommerciaux
 * \brief   File for API management of myobject.
 */

/**
 * API class for gestiondescommerciaux myobject
 *
 * @smart-auto-routing false
 * @access protected
 * @class  DolibarrApiAccess {@requires user,external}
 */
class GestionDesCommerciauxApi extends DolibarrApi
{
    /**
