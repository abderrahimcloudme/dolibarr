...
/**
 * \file    test/functional/GestionCommerciauxFunctionalTest.php
...
/**
 * Class GestionCommerciauxFunctionalTest
 *
 ...
 *
 * @package Testgestioncommerciaux
 */
class GestionCommerciauxFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
...
//        )
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modGestionCommerciaux')->click();
		} else {
			// Disable the module
			$this->byHref('modGestionCommerciaux')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/gestioncommerciaux/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('gestioncommerciaux/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/gestioncommerciaux/admin/about.php');
		$this->authenticate();
		return $this->assertContains('gestioncommerciaux/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('gestioncommerciauxwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modGestionCommerciaux_GestionCommerciauxTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modGestionCommerciaux_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
