...
/**
 * \file        class/appels.class.php
 * \ingroup     gestioncommerciaux
 * \brief       This file is a CRUD class file for Appels (Create/Read/Update/Delete)
 */
 ...
 * Class for Appels
 */
class Appels extends CommonObject
{
	/**
	 * @var string ID to identify managed object
	 */
	public $element = 'appels';

	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'gestioncommerciaux_appels';

	/**
	 * @var int  Does appels support multicompany module ? 0=No test on entity, 1=Test with field entity, 2=Test with link by societe
	 */
	public $ismultientitymanaged = 0;

	/**
	 * @var int  Does appels support extrafields ? 0=No, 1=Yes
	 */
	public $isextrafieldmanaged = 1;

	/**
	 * @var string String with name of icon for appels. Must be the part after the 'object_' into object_appels.png
	 */
	public $picto = 'appels@gestioncommerciaux';
	...
	public $fields=array(
		...
		'client' => array('type'=>'integer:Client:custom/gestioncommerciaux/class/client.class.php', 'label'=>'Client', 'enabled'=>1, 'visible'=>-1, 'position'=>50, 'notnull'=>-1,),
	);
	public $rowid;
	public $ref;
	public $description;
	 ...
	 */
	//public $table_element_line = 'appelsdet';

	/**
	 * @var int    Field with ID of parent key if this field has a parent
	 */
	//public $fk_element = 'fk_appels';

	/**
	 * @var int    Name of subtable class that manage subtable lines
	 */
	//public $class_element_line = 'Appelsline';

	/**
	 * @var array  Array of child tables (child tables to delete before deleting a record)
	 */
	//protected $childtables=array('appelsdet');

	/**
	 * @var AppelsLine[]     Array of subtable lines
	 */
	//public $lines = array();
	...
	/*public function fetchLines()
	{
		...
		// Load lines with object AppelsLine
	...
	function getNomUrl($withpicto=0, $option='', $notooltip=0, $morecss='', $save_lastsearch_value=-1)
	{
        ...
        $label = '<u>' . $langs->trans("Appels") . '</u>';
        $label.= '<br>';
        $label.= '<b>' . $langs->trans('Ref') . ':</b> ' . $this->ref;

        $url = dol_buildpath('/gestioncommerciaux/appels_card.php',1).'?id='.$this->id;
        ...
        if (empty($notooltip))
        {
            ...
            /*
             $hookmanager->initHooks(array('appelsdao'));
...
/**
 * Class AppelsLine. You can also remove this and generate a CRUD class for lines objects.
 */
/*
class AppelsLine
{
