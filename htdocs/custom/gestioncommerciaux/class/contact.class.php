...
/**
 * \file        class/contact.class.php
 * \ingroup     gestioncommerciaux
 * \brief       This file is a CRUD class file for Contact (Create/Read/Update/Delete)
 */
...
class Contact extends CommonObject
{
	 ...
	 */
	public $table_element = 'gestioncommerciaux_contact';

	/**
	 * @var int  Does contact support multicompany module ? 0=No test on entity, 1=Test with field entity, 2=Test with link by societe
	 */
	public $ismultientitymanaged = 0;

	/**
	 * @var int  Does contact support extrafields ? 0=No, 1=Yes
	 */
	public $isextrafieldmanaged = 1;

	/**
	 * @var string String with name of icon for contact. Must be the part after the 'object_' into object_contact.png
	 */
	public $picto = 'contact@gestioncommerciaux';
	...
	public $fields=array(
		...
		'libelle' => array('type'=>'varchar(128)', 'label'=>'Nom / Libellé', 'enabled'=>1, 'visible'=>-1, 'position'=>11, 'notnull'=>-1,),
		'telephone' => array('type'=>'varchar(50)', 'label'=>'Telephone', 'enabled'=>1, 'visible'=>-1, 'position'=>14, 'notnull'=>-1,),
	);
	public $rowid;
	public $ref;
	public $label;
	 ...
	 */
	//public $table_element_line = 'contactdet';

	/**
	 * @var int    Field with ID of parent key if this field has a parent
	 */
	//public $fk_element = 'fk_contact';

	/**
	 * @var int    Name of subtable class that manage subtable lines
	 */
	//public $class_element_line = 'Contactline';

	/**
	 * @var array  Array of child tables (child tables to delete before deleting a record)
	 */
	//protected $childtables=array('contactdet');

	/**
	 * @var ContactLine[]     Array of subtable lines
	 */
	//public $lines = array();
	...
	/*public function fetchLines()
	{
		...
		// Load lines with object ContactLine
	...
	function getNomUrl($withpicto=0, $option='', $notooltip=0, $morecss='', $save_lastsearch_value=-1)
	{
        ...
        $url = dol_buildpath('/gestioncommerciaux/contact_card.php',1).'?id='.$this->id;
...
/**
 * Class ContactLine. You can also remove this and generate a CRUD class for lines objects.
 */
/*
class ContactLine
{
