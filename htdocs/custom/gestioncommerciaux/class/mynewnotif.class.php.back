...
/**
 * \file        class/mynewnotif.class.php
 * \ingroup     gestioncommerciaux
 * \brief       This file is a CRUD class file for MyNewNotif (Create/Read/Update/Delete)
 */
...
/**
 * Class for MyNewNotif
 */
class MyNewNotif extends CommonObject
{
	/**
	 * @var string ID to identify managed object
	 */
	public $element = 'mynewnotif';

	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'gestioncommerciaux_mynewnotif';

	/**
	 * @var int  Does mynewnotif support multicompany module ? 0=No test on entity, 1=Test with field entity, 2=Test with link by societe
	 */
	public $ismultientitymanaged = 0;

	/**
	 * @var int  Does mynewnotif support extrafields ? 0=No, 1=Yes
	 */
	public $isextrafieldmanaged = 1;

	/**
	 * @var string String with name of icon for mynewnotif. Must be the part after the 'object_' into object_mynewnotif.png
	 */
	public $picto = 'mynewnotif@gestioncommerciaux';
	...
	public $fields=array(
		...
		'type' => array('type'=>'integer', 'label'=>'Type', 'enabled'=>1, 'visible'=>-1, 'position'=>50, 'notnull'=>-1,),
	);
	public $rowid;
	public $ref;
	public $label;
	 ...
	 */
	//public $table_element_line = 'mynewnotifdet';

	/**
	 * @var int    Field with ID of parent key if this field has a parent
	 */
	//public $fk_element = 'fk_mynewnotif';

	/**
	 * @var int    Name of subtable class that manage subtable lines
	 */
	//public $class_element_line = 'MyNewNotifline';

	/**
	 * @var array  Array of child tables (child tables to delete before deleting a record)
	 */
	//protected $childtables=array('mynewnotifdet');

	/**
	 * @var MyNewNotifLine[]     Array of subtable lines
	 */
	//public $lines = array();
	...
	/*public function fetchLines()
	{
		...
		// Load lines with object MyNewNotifLine
	...
	function getNomUrl($withpicto=0, $option='', $notooltip=0, $morecss='', $save_lastsearch_value=-1)
	{
        ...
        $label = '<u>' . $langs->trans("MyNewNotif") . '</u>';
        $label.= '<br>';
        $label.= '<b>' . $langs->trans('Ref') . ':</b> ' . $this->ref;

        $url = dol_buildpath('/gestioncommerciaux/mynewnotif_card.php',1).'?id='.$this->id;
        ...
        if (empty($notooltip))
        {
            ...
            {
                $label=$langs->trans("ShowMyNewNotif");
            ...
            /*
             $hookmanager->initHooks(array('mynewnotifdao'));
...
/**
 * Class MyNewNotifLine. You can also remove this and generate a CRUD class for lines objects.
 */
/*
class MyNewNotifLine
{
	// @var int ID
	public $id;
