...
/**
 *	\file       htdocs/gestioncommerciaux/template/gestioncommerciauxindex.php
 *	\ingroup    gestioncommerciaux
 *	\brief      Home page of gestioncommerciaux top menu
 */
...
$langs->loadLangs(array("gestioncommerciaux@gestioncommerciaux"));

$action=GETPOST('action', 'alpha');


// Securite acces client
if (! $user->rights->gestioncommerciaux->read) accessforbidden();
...
llxHeader("",$langs->trans("GestionCommerciauxArea"));

print load_fiche_titre($langs->trans("GestionCommerciauxArea"),'','gestioncommerciaux.png@gestioncommerciaux');
...
// Draft MyObject
if (! empty($conf->gestioncommerciaux->enabled) && $user->rights->gestioncommerciaux->read)
{
	$langs->load("orders");
