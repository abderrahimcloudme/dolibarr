...
dol_include_once("/gestioncommerciaux/class/myobject.class.php");


/**
 * mailing_mailinglist_gestioncommerciaux
 */
class mailing_mailinglist_gestioncommerciaux_myobject extends MailingTargets
{
	// CHANGE THIS: Put here a name not already used
	var $name='mailinglist_gestioncommerciaux_myobject';
	...
	var $picto='gestioncommerciaux@gestioncommerciaux';
	...
	function __construct($db)
	{
		...
		{
			$this->enabled=in_array('gestioncommerciaux',$conf->modules)?1:0;
		}
	}
	...
	function url($id)
	{
		return '<a href="'.dol_buildpath('/gestioncommerciaux/myobject_card.php',1).'?id='.$id.'">'.img_object('',"generic").'</a>';
	}
	...
	function add_to_target($mailing_id,$filtersarray=array())
	{
		...
		if ($result)
		{
			...
			dol_syslog("mailinglist_gestioncommerciaux_myobject.modules.php: mailing ".$num." targets found");
