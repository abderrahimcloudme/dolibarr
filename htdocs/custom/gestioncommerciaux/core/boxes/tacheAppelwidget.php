...
/**
 * \file    modulebuilder/template/core/boxes/tacheAppelwidget.php
 * \ingroup gestioncommerciaux
 * \brief   Widget provided by GestionCommerciaux
 *
 ...
 */
class tacheAppelwidget extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "gestioncommerciauxbox_tacheAppelwidget";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "gestioncommerciaux_tacheAppelwidget";
	 ...
	 */
	public $depends = array('gestioncommerciaux');
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		$langs->load("boxes");
		$langs->load('gestioncommerciaux_tacheAppelwidget');

		parent::__construct($db, $param);

		$this->boxlabel = $langs->transnoentitiesnoconv("MyWidget2");

		$this->param = $param;

		//$this->enabled = $conf->global->FEATURES_LEVEL > 0;         // Condition when module is enabled or not
		//$this->hidden = ! ($user->rights->gestioncommerciaux->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		//include_once DOL_DOCUMENT_ROOT . "/gestioncommerciaux/class/gestioncommerciaux.class.php";

		// Populate the head at runtime
		$text = $langs->trans("GestionCommerciauxBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_gestioncommerciaux_tacheAppelwidget',
