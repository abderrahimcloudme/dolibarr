...
/**
 * \file    modulebuilder/template/core/boxes/gestioncommerciauxwidget1.php
 ...
 */
class gestioncommerciauxwidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "gestioncommerciauxbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "gestioncommerciaux@gestioncommerciaux";
	...
	public function loadBox($max = 5)
	{
		...
		$this->info_box_head = array(
			...
			'subpicto' => 'object_gestioncommerciaux@gestioncommerciaux',
