...
dol_include_once("/projects/class/myobject.class.php");


/**
 * mailing_mailinglist_projects
 */
class mailing_mailinglist_projects_myobject extends MailingTargets
{
	// CHANGE THIS: Put here a name not already used
	var $name='mailinglist_projects_myobject';
	...
	function __construct($db)
	{
		...
		{
			$this->enabled=in_array('projects',$conf->modules)?1:0;
		}
	}
	...
	function url($id)
	{
		return '<a href="'.dol_buildpath('/projects/myobject_card.php',1).'?id='.$id.'">'.img_object('',"generic").'</a>';
	}
	...
	function add_to_target($mailing_id,$filtersarray=array())
	{
		...
		if ($result)
		{
			...
			dol_syslog("mailinglist_projects_myobject.modules.php: mailing ".$num." targets found");
