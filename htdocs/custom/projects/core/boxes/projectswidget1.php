...
/**
 * \file    modulebuilder/template/core/boxes/projectswidget1.php
 * \ingroup projects
 * \brief   Widget provided by Projects
 *
 ...
 */
class projectswidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "projectsbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "projects@projects";
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		//$this->hidden = ! ($user->rights->projects->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		//include_once DOL_DOCUMENT_ROOT . "/projects/class/projects.class.php";

		// Populate the head at runtime
		$text = $langs->trans("ProjectsBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_projects@projects',
