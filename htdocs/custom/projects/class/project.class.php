...
/**
 * \file        class/project.class.php
 * \ingroup     projects
 * \brief       This file is a CRUD class file for Project (Create/Read/Update/Delete)
 */
...
class Project extends CommonObject
{
	 ...
	 */
	public $table_element = 'projects_project';

	/**
	 * @var int  Does project support multicompany module ? 0=No test on entity, 1=Test with field entity, 2=Test with link by societe
	 */
	public $ismultientitymanaged = 0;

	/**
	 * @var int  Does project support extrafields ? 0=No, 1=Yes
	 */
	public $isextrafieldmanaged = 1;

	/**
	 * @var string String with name of icon for project. Must be the part after the 'object_' into object_project.png
	 */
	public $picto = 'project@projects';
	 ...
	 */
	//public $table_element_line = 'projectdet';
	 ...
	 */
	//public $class_element_line = 'Projectline';

	/**
	 * @var array  Array of child tables (child tables to delete before deleting a record)
	 */
	//protected $childtables=array('projectdet');

	/**
	 * @var ProjectLine[]     Array of subtable lines
	 */
	//public $lines = array();
	...
	/*public function fetchLines()
	{
		...
		// Load lines with object ProjectLine
	...
	function getNomUrl($withpicto=0, $option='', $notooltip=0, $morecss='', $save_lastsearch_value=-1)
	{
        ...
        $label = '<u>' . $langs->trans("Project") . '</u>';
        $label.= '<br>';
        $label.= '<b>' . $langs->trans('Ref') . ':</b> ' . $this->ref;

        $url = dol_buildpath('/projects/project_card.php',1).'?id='.$this->id;
...
/**
 * Class ProjectLine. You can also remove this and generate a CRUD class for lines objects.
 */
/*
class ProjectLine
{
