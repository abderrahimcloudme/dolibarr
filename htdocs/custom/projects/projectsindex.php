...
/**
 *	\file       htdocs/projects/template/projectsindex.php
 *	\ingroup    projects
 *	\brief      Home page of projects top menu
 */
...
$langs->loadLangs(array("projects@projects"));

$action=GETPOST('action', 'alpha');


// Securite acces client
if (! $user->rights->projects->read) accessforbidden();
...
llxHeader("",$langs->trans("ProjectsArea"));

print load_fiche_titre($langs->trans("ProjectsArea"),'','projects.png@projects');
...
// Draft MyObject
if (! empty($conf->projects->enabled) && $user->rights->projects->read)
{
	$langs->load("orders");
