...
/**
 * \file    test/functional/ProjectsFunctionalTest.php
 * \ingroup projects
 ...
 */
class ProjectsFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
...
//        )
	...
	{
		$this->url('/custom/projects/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('projects/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/projects/admin/about.php');
		$this->authenticate();
		return $this->assertContains('projects/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('projectswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modProjects_ProjectsTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modProjects_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
