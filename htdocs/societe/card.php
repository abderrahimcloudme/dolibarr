...
else
{
    ...
    if ($action == 'create')
    {
        ...
        print '<select class="flat" name="client" id="customerprospect" disabled>';
    ...
    elseif ($action == 'edit')
    {
        ...
        if ($socid)
        {
            ...
            if (empty($conf->global->SOCIETE_DISABLE_PROSPECTS) && empty($conf->global->SOCIETE_DISABLE_CUSTOMERS)) print '<option value="3">'.$langs->trans('ProspectCustomer').'</option>';
